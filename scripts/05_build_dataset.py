"""
05_build_dataset.py — CLI entry point for the surrogate pipeline.
...
def main(config: str, paths: str, mode: str) -> None:
    """Run stage: 05_build_dataset.py"""
    log.info("Starting 05_build_dataset.py | mode=%s | config=%s | paths=%s", mode, config, paths)
    raise NotImplementedError("Not yet implemented — see docs/blueprints/BLUEPRINT_05_BUILD.md")

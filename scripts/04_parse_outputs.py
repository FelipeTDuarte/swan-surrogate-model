"""
04_parse_outputs.py — CLI entry point for the surrogate pipeline.
...
def main(config: str, paths: str, mode: str) -> None:
    """Run stage: 04_parse_outputs.py"""
    log.info("Starting 04_parse_outputs.py | mode=%s | config=%s | paths=%s", mode, config, paths)
    raise NotImplementedError("Not yet implemented — see docs/blueprints/BLUEPRINT_04_PARSE.md")
